        ...
        <form method="POST">
            <table>
                <tr>
                    <td>ID</td>
                    <td>
                        <input type="text" name="id" value="<?php global $tvalores;   foreach ($tvalores as $user) : endforeach;

                        $user->id ?>" <?= $orden=$_GET['orden'];
                        ($orden == "Detalles" || $orden == "Modificar") ? "readonly" : "" ?> size="20" autofocus>
                    </td>
                </tr>
                <tr>
                    <td>First_name</td>
